...
_JellyX("Jelly X Amplitude", Range(-10, 10)) = 0.1
_JellyXs("Jelly X Amp Speed", Range(-10, 10)) = 1
[Space(10)]
_JellyXB("Jelly X Bias", Range(-10, 10)) = 0.1
_JellyXBs("Jelly X Bias Speed", Range(-10, 10)) = 1
[Space(10)]
_JellyY("Jelly Y Amplitude", Range(-10, 10)) = 0.1
_JellyYs("Jelly Y Speed", Range(-10, 10)) = 1
[Space(10)]
_JellyYB("Jelly Y Bias", Range(-10, 10)) = 0.1
_JellyYBs("Jelly Y Bias Speed", Range(-10, 10)) = 1
